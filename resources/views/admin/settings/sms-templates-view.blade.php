...
@section('page-title', 'View SMS Template')
...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-[#015425] to-[#027a3a] rounded-lg shadow-lg p-6 text-white">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
                <h1 class="text-2xl sm:text-3xl font-bold mb-2">View SMS Template</h1>
                <p class="text-white text-opacity-90 text-sm sm:text-base">View SMS template details and configuration</p>
            </div>
            <div class="mt-4 md:mt-0 flex space-x-3">
                <a href="{{ route('admin.settings.sms-templates.edit', $templateType) }}" class="inline-flex items-center px-6 py-3 bg-white text-[#015425] rounded-md hover:bg-gray-100 transition font-medium shadow-md">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="bg-gray-50 rounded-lg p-6 mb-6">
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-4">
                <p class="text-gray-800 whitespace-pre-wrap">{{ $templateContent }}</p>
            </div>
            <div class="mt-4 flex items-center justify-between">
                <div class="text-sm text-gray-600">
                    <strong>Character Count:</strong> {{ strlen($templateContent) }}/500
                </div>
        ...
        <div class="mt-6 flex justify-between">
            ...
            <a href="{{ route('admin.settings.sms-templates.edit', $templateType) }}" class="px-6 py-2 bg-[#015425] text-white rounded-md hover:bg-[#013019] transition font-medium">
                Edit Template
            </a>
        </div>
    </div>
