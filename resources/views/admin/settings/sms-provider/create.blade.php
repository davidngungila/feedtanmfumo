                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="username" id="provider_username" value="{{ old('username') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-[#015425] focus:border-[#015425]" placeholder="SMS gateway username" required>
                                <p class="text-xs text-gray-500 mt-1">SMS gateway username</p>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">SMS Password <span class="text-red-500">*</span></label>
                                <input type="password" name="password" id="provider_password" value="{{ old('password') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-[#015425] focus:border-[#015425]" placeholder="SMS gateway password" required>
                                <p class="text-xs text-gray-500 mt-1">SMS gateway password</p>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="url" name="api_url" id="provider_api_url" value="{{ old('api_url', 'https://messaging-service.co.tz/api/sms') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-[#015425] focus:border-[#015425]" placeholder="https://messaging-service.co.tz/api/sms" required>
                            </div>
