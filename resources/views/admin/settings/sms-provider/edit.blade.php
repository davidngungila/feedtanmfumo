                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="username" id="provider_username" value="{{ old('username', $smsProvider->username) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-[#015425] focus:border-[#015425]" placeholder="cedcce9becad866f59beac1fd5a235bc" required>
                            ...
                            <div>
                                ...
                                <input type="password" name="password" id="provider_password" value="" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-[#015425] focus:border-[#015425]" placeholder="Leave blank if not required">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="url" name="api_url" id="provider_api_url" value="{{ old('api_url', $smsProvider->api_url) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-[#015425] focus:border-[#015425]" placeholder="https://messaging-service.co.tz/api/sms/v2/text/single" required>
