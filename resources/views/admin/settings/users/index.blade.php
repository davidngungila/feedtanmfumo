...
<div class="space-y-6">
    <div class="bg-gradient-to-r from-[#015425] to-[#027a3a] rounded-lg shadow-lg p-6 text-white">
        <h1 class="text-2xl sm:text-3xl font-bold mb-2">Users Management</h1>
        <p class="text-white text-opacity-90">Manage system users and their access</p>
    </div>

    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h2 class="text-lg font-semibold text-gray-900">All Users</h2>
            <a href="{{ route('admin.users.create') }}" class="px-4 py-2 bg-[#015425] text-white rounded-md hover:bg-[#027a3a]">
                Add New User
            </a>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="{{ route('admin.users.edit', $user) }}" class="text-[#015425] hover:text-[#027a3a]">Edit</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
