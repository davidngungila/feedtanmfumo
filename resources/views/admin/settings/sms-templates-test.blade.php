...
@section('page-title', 'Test SMS Template')
...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-[#015425] to-[#027a3a] rounded-lg shadow-lg p-6 text-white">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
                <h1 class="text-2xl sm:text-3xl font-bold mb-2">Test SMS Template</h1>
                <p class="text-white text-opacity-90 text-sm sm:text-base">Send a test SMS to verify template content and formatting</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <div class="mb-6">
            ...
            <div class="bg-gray-50 rounded-lg p-4">
                <div class="text-sm text-gray-800 whitespace-pre-wrap">{{ $templateContent }}</div>
                <div class="mt-2 text-xs text-gray-500">Character count: {{ strlen($templateContent) }}/500</div>
            </div>
        </div>
    </div>

    <form action="{{ route('admin.settings.sms-templates.send', $templateType) }}" method="POST">
        @csrf
