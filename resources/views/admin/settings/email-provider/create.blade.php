...
@section('page-title', 'Add Email Provider')
...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-[#015425] to-[#027a3a] rounded-lg shadow-lg p-6 text-white">
        <div class="flex flex-col md:flex-row md:items-center">
            <div class="flex-1">
                <h1 class="text-2xl sm:text-3xl font-bold mb-2">Add Email Provider</h1>
                <p class="text-white text-opacity-90 text-sm sm:text-base">Configure a new email gateway provider for system notifications</p>
            </div>
    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('admin.email-provider.store') }}" method="POST">
                @csrf
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="name" value="{{ old('name', 'Primary Email Gateway') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-[#015425] focus:border-[#015425]" placeholder="e.g., Primary Email Gateway" required>
                            ...
                            <div>
                                ...
                                <input type="text" name="host" value="{{ old('host', 'smtp.gmail.com') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-[#015425] focus:border-[#015425]" placeholder="smtp.gmail.com" required>
                            ...
                            <div>
                                ...
                                <input type="number" name="port" value="{{ old('port', '587') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-[#015425] focus:border-[#015425]" min="1" max="65535" required>
                            ...
                            <div>
                                ...
                                <input type="text" name="username" value="{{ old('username') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-[#015425] focus:border-[#015425]" placeholder="your-email@gmail.com">
                                <p class="text-xs text-gray-500 mt-1">Your full email address</p>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">SMTP Password</label>
                                <input type="password" name="password" value="{{ old('password') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-[#015425] focus:border-[#015425]" placeholder="App Password for Gmail">
                            ...
                            <div>
                                ...
                                <input type="email" name="from_address" value="{{ old('from_address') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-[#015425] focus:border-[#015425]" placeholder="noreply@feedtan.com" required>
                                <p class="text-xs text-gray-500 mt-1">Email address that will appear as sender</p>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">From Name</label>
                                <input type="text" name="from_name" value="{{ old('from_name', 'FeedTan Community Microfinance Group') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-[#015425] focus:border-[#015425]" placeholder="FeedTan CMG">
                                <p class="text-xs text-gray-500 mt-1">Name that will appear as sender</p>
                            </div>

                            <div class="md:col-span-2">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Description</label>
                                <textarea name="description" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-[#015425] focus:border-[#015425]" placeholder="Optional description for this provider">{{ old('description') }}</textarea>
