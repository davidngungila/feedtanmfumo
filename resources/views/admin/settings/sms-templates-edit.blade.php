    ...
    <div class="bg-gradient-to-r from-[#015425] to-[#027a3a] rounded-lg shadow-lg p-6 text-white">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="text-white text-opacity-90 text-sm sm:text-base">Modify SMS template content and configuration</p>
            </div>
            <div class="mt-4 md:mt-0 flex space-x-3">
                <a href="{{ route('admin.settings.sms-templates.view', $templateType) }}" class="inline-flex items-center px-6 py-3 bg-white text-[#015425] rounded-md hover:bg-gray-100 transition font-medium shadow-md">
    ...
    <form action="{{ route('admin.settings.sms-templates.update') }}" method="POST">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <div class="mb-6">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-[#015425]">{{ $templateName }} SMS</h2>
                    <p class="text-gray-600">SMS template for {{ $templateName }}</p>
                </div>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-2">
                                <span id="charCount" class="text-sm font-medium {{ strlen($templateContent) > 450 ? 'text-red-600' : (strlen($templateContent) > 400 ? 'text-yellow-600' : 'text-gray-900') }}">
                                    {{ strlen($templateContent) }}/500
                                </span>
                                @if(strlen($templateContent) > 450)
                                    <span class="px-2 py-1 text-xs font-medium rounded-full bg-red-100 text-red-800">Approaching Limit</span>
                                @elseif(strlen($templateContent) > 400)
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex justify-between">
                <div class="flex space-x-3">
                    ...
                    <a href="{{ route('admin.settings.sms-templates.view', $templateType) }}" class="px-6 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 transition font-medium">
                        View Template
                    </a>
                </div>
