...
<div class="max-w-6xl mx-auto space-y-6">
        ...
        <div class="flex flex-col md:flex-row items-center md:items-start">
            <div class="flex items-center space-x-6 mb-4 md:mb-0 flex-1">
                ...
                <div>
                    ...
                    <p class="text-lg text-white text-opacity-90 mb-1">{{ $user->email }}</p>
                    @if($user->phone)
                        <p class="text-sm text-white text-opacity-75">{{ $user->phone }}</p>
                    @endif
                </div>
            </div>
            <div class="mt-4 md:mt-0 md:ml-auto flex flex-wrap gap-3 justify-end">
                ...
                <a href="{{ route('admin.profile.settings') }}" class="inline-flex items-center px-6 py-3 bg-white text-[#015425] rounded-md hover:bg-gray-100 transition font-medium shadow-md">
                    Settings
                </a>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-600 mb-1">Loans</p>
                            <p class="text-2xl font-bold text-[#015425]">{{ $stats['loans'] }}</p>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-green-600">{{ $stats['savings'] }}</p>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-600 mb-1">Investments</p>
                            <p class="text-2xl font-bold text-purple-600">{{ $stats['investments'] }}</p>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-orange-600">{{ $stats['issues'] }}</p>
                        </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-xl font-bold text-[#015425] mb-4">Personal Information</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-900">{{ $user->address }}</p>
                    </div>
                    @endif
                    <div>
            ...
            <!-- Roles & Permissions -->
            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-xl font-bold text-[#015425] mb-4">Roles & Permissions</h2>
                <div class="flex flex-wrap gap-2">
                    @forelse($user->roles as $role)
                        <span class="px-4 py-2 bg-[#015425] text-white rounded-full text-sm font-medium">
                            {{ $role->name }}
                        </span>
                    @empty
            ...
            <!-- Bio -->
            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-xl font-bold text-[#015425] mb-4">About</h2>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="space-y-2">
                    <a href="{{ route('admin.profile.edit') }}" class="flex items-center px-4 py-3 rounded-md hover:bg-gray-50 transition text-gray-700">
                        <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                        </svg>
                        Edit Profile
                    </a>
                    <a href="{{ route('admin.profile.settings') }}" class="flex items-center px-4 py-3 rounded-md hover:bg-gray-50 transition text-gray-700">
                        <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center px-4 py-3 rounded-md hover:bg-gray-50 transition text-gray-700">
                        <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Account Security -->
            <div class="bg-white rounded-lg shadow-md p-6">
                <h3 class="text-lg font-bold text-[#015425] mb-4">Account Security</h3>
                <div class="space-y-3">
                    <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('admin.profile.edit') }}#password" class="block w-full mt-4 px-4 py-2 text-center bg-[#015425] text-white rounded-md hover:bg-[#013019] transition text-sm font-medium">
                        Change Password
                    </a>
                </div>
            </div>
