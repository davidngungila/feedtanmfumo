...
<head>
    <meta charset="utf-8">
    <title>Welfare Fund Status Report - FeedTan CMG</title>
    <style>
        @page {
            margin: 10mm 12mm;
            size: A4;
...
<body>
    <div class="header">
        ...
        <div class="title">{{ $documentTitle ?? 'Welfare Fund Status Report' }}</div>
        <div class="serial-number">Serial No: FCMGWFSR-{{ date('Ymd') }}-{{ str_pad(1, 4, '0', STR_PAD_LEFT) }}</div>
    ...
    <div class="stats">
        <div class="stats-row">
            ...
            <div class="stats-cell"><strong>{{ number_format($stats['opening_balance'], 2) }} TZS</strong></div>
        ...
        <div class="stats-row">
            ...
            <div class="stats-cell"><strong>{{ number_format($stats['closing_balance'], 2) }} TZS</strong></div>
        </div>
    </div>
    ...
    <div class="footer">
        <p>FeedTan Community Microfinance Group - Welfare Fund Status Report</p>
        <p>Report generated on {{ now()->format('F d, Y \a\t H:i:s') }}</p>
        <p>Serial No: FCMGWFSR-{{ date('Ymd') }}-{{ str_pad(1, 4, '0', STR_PAD_LEFT) }}</p>
    </div>
</body>
</html>
