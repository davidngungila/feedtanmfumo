...
<head>
    ...
    <title>{{ $eventTitle ?? 'Welfare Update' }} - FeedTan CMG</title>
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <h4>{{ $cardTitle ?? 'Ustawi wa Jamii' }}</h4>
                </div>
                ...
                <div class="button-container">
                    <a href="{{ url('/member/welfare') }}" class="action-button">Angalia Hali ya Ustawi</a>
                </div>
            </div>
            
            <p style="font-size: 14px; color: #4a5568;">Tunajivunia kuwa sehemu ya maendeleo yako!</p>
        ...
        <div class="footer">
            FeedTan CMG Welfare Management System
        </div>
    </div>
</body>
</html>
