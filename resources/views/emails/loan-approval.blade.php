...
<head>
    ...
    <title>Loan Application Approved - FeedTan CMG</title>
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p style="font-size: 14px; color: #4a5568;">Tunafurahi kukutangazia kuwa ombi lako la mkopo limeidhinishwa!</p>
            
            <div class="card">
                <div class="card-header">
                    <span class="icon">✅</span>
                    <h4>Mkopo Wako Umeidhinishwa</h4>
                </div>
                <table class="details-table">
                    <tr>
                        <td>Kiasi cha Mkopo:</td>
                        <td><strong>{{ number_format($loanDetails['amount'] ?? 0, 0) }} TZS</strong></td>
                    </tr>
                    <tr>
                        <td>Kipindi cha Malipo:</td>
                        <td>{{ $loanDetails['repayment_period'] ?? 'N/A' }} miezi</td>
                    </tr>
                    <tr>
                        <td>Kiwango cha Riba:</td>
                        <td>{{ $loanDetails['interest_rate'] ?? 'N/A' }}%</td>
                    </tr>
                    <tr>
                        <td>Tarehe ya Kukamilika:</td>
                        <td>{{ $loanDetails['maturity_date'] ?? 'N/A' }}</td>
                    </tr>
                </table>
                <div class="button-container">
                    <a href="{{ url('/member/loans') }}" class="action-button">Angalia Maelezo zaidi</a>
                </div>
            </div>
            
            <p style="font-size: 14px; color: #4a5568;">Tafadhali fika ofisi yetu au piga {{ $organizationInfo['phone'] ?? '+255 123 456 789' }} kujua zaidi kuhusu mkopo wako.</p>
