...
<head>
    ...
    <title>{{ $eventTitle ?? 'Investment Update' }} - FeedTan CMG</title>
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <h4>{{ $cardTitle ?? 'Uwekezaji Wako' }}</h4>
                </div>
                ...
                <div class="button-container">
                    <a href="{{ url('/member/investments') }}" class="action-button">Angalia Uwekezaji Wako</a>
                </div>
            </div>
            
            <p style="font-size: 14px; color: #4a5568;">Endelea kuwekeza na ujikumbatie fursa za kimaendeleo!</p>
        ...
        <div class="footer">
            FeedTan CMG Investment Management System
        </div>
    </div>
</body>
</html>
