...
<head>
    ...
    <title>{{ $title ?? 'Notification' }} - FeedTan CMG</title>
    ...
    <style>
        ...
        .details-table td { padding: 8px 0; font-size: 14px; color: #4a5568; border-bottom: 1px solid #edf2f7; }
...
<body>
    <div class="email-container">
        ...
        <div class="footer">
            {{ $footerText ?? 'FeedTan CMG Notification System' }}
        </div>
    </div>
</body>
</html>
