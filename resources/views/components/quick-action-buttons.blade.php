...
<div class="flex items-center space-x-2">
    ...
    <a href="https://wa.me/{{ $whatsappLink }}" 
       ...
       class="p-2 text-green-600 hover:text-green-700 hover:bg-green-50 rounded-full transition focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
    ...
    <a href="tel:{{ $phoneFormatted }}" 
       class="p-2 text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-full transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
       title="Call: {{ $phone }}">
    ...
    @if($email)
    <a href="mailto:{{ $email }}" 
       class="p-2 text-[#015425] hover:text-[#027a3a] hover:bg-green-50 rounded-full transition focus:outline-none focus:ring-2 focus:ring-[#015425] focus:ring-offset-2"
       title="Email: {{ $email }}">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
