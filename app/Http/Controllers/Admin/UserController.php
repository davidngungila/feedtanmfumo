...
class UserController extends Controller
{
    ...
    {
        $user->load([
            'roles.permissions', 'loans', 'savingsAccounts', 'investments', 
            'socialWelfares', 'issues', 'transactions',
            'membershipType', 'membershipApprovedBy', 'editingRequestedBy'
        ]);
     ...
     */
    public function indexMemberships(Request $request)
    {
     ...
     */
    public function exportMembershipPdf(User $user)
    {
     ...
     */
    public function approveMembership(Request $request, User $user)
    {
        $request->validate([
     ...
     */
    public function rejectMembership(Request $request, User $user)
    {
        $request->validate([
     ...
     * Suspend membership
     */
    public function suspendMembership(Request $request, User $user)
    {
        $request->validate([
     ...
     */
    public function reactivateMembership(User $user)
    {
        $user->update([
            'membership_status' => 'approved',
            'status_reason' => null,
     ...
     */
    public function requestMembershipEdits(Request $request, User $user)
    {
        $request->validate([
     ...
     */
    public function clearMembershipEditRequest(User $user)
    {
        $user->update([
